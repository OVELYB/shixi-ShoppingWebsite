    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="/handle/addhandle"> 添加内容</a> </li>
                <li>搜索：</li>
                <li>首页
        ...
        <table class="table table-hover text-center">
            ...
            <volist name="list" id="vo">
                ...
                <tr>
                    ...
                    <td>${u.parentId}</td>
                    <td>${u.active}</td>
                    <td><div class="button-group"> <a class="button border-main" href="/back/updatehandle?id=${u.id}"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="/back/deletehandle?id=${u.id}"><span class="icon-trash-o"></span> 删除</a> </div></td>
                </tr>
                </c:forEach>
