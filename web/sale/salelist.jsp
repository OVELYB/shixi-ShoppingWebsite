...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a href="/sale/saleinfo" target="right"><span class="icon-caret-right"></span>用户信息显示</a></li>
        <li><a href="pass.html" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
        <li><a href="/sale/salehandle" target="right"><span class="icon-caret-right"></span>品类管理</a></li>
